...
/**void NSicherNeu()**/
int main() {
	klee_make_symbolic(&P1_marking_member_0, sizeof(P1_marking_member_0),
			"P1_marking_member_0");
	klee_make_symbolic(&P2_marking_member_0, sizeof(P2_marking_member_0),
			"P2_marking_member_0");
	klee_make_symbolic(&P3_marking_member_0, sizeof(P3_marking_member_0),
			"P3_marking_member_0");
