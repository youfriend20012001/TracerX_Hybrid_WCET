...
static inline int Test(matrix);

static inline int Initialize(matrix);

static inline int InitSeed(void);

static inline int Sum(matrix);

static inline int RandomInteger(void);
...

{
   ...
   klee_make_symbolic(&Seed, sizeof(Seed),
	  				"Seed");

   klee_make_symbolic(&Array, sizeof(Array),
   	  				"Array");
   //InitSeed();
...
static inline int Test(matrix Array)
...
static inline int Initialize(matrix Array)
...
static inline int Sum(matrix Array)
