...
void FH_DU(void) {
	...
	//end generic_KINDERSICHERUNG_CTRL
	...
	if (!SYS_bit_get(Bitlist,
			active_FH_TUERMODUL_CTRL_IDX) && SYS_bit_get(Bitlist,active_FH_TUERMODUL_CTRL_old_IDX) && !SYS_bit_get(Bitlist,active_FH_TUERMODUL_CTRL_copy_IDX)) {
			...
			//case 1: /** state OEFFNEN in chart FH_TUERMODUL_CTRL **/
				...
				//case 1: /** state TIPP_SCHLIESSEN in chart FH_TUERMODUL_CTRL **/
					...
					//case 1: /** state REVERSIEREN1 in chart FH_TUERMODUL_CTRL **/
						...
						//break;
					} else if (MANUELL_SCHLIESSEN_FH_TUERMODUL_CTRL_next_state
							== 2) {
						if (SYS_bit_get(Bitlist,
								FH_TUERMODUL__EINKLEMMUNG_IDX)) {
							stable = 0;
	...
	//end generic_EINKLEMMSCHUTZ_CTRL
	...
	if (!SYS_bit_get(Bitlist,
			active_BLOCK_ERKENNUNG_CTRL_IDX) && SYS_bit_get(Bitlist,active_BLOCK_ERKENNUNG_CTRL_old_IDX) && !SYS_bit_get(Bitlist,active_BLOCK_ERKENNUNG_CTRL_copy_IDX)) {
		SYS_bit_clr(Bitlist,
				entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRL_IDX);
	}
	if (SYS_bit_get(Bitlist, active_BLOCK_ERKENNUNG_CTRL_IDX)) {
		...
		if (BLOCK_ERKENNUNG_CTRL_BLOCK_ERKENNUNG_CTRL_next_state == 2) {
	...
	//end generic_BLOCK_ERKENNUNG_CTRL
	...
	if (!stable) {
		...
		if (SYS_bit_get(Bitlist, active_FH_TUERMODUL_CTRL_IDX)) {
			...
			SYS_bit_cpy(Bitlist,
					entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_copy_IDX, Bitlist,
					entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_IDX);
			SYS_bit_cpy(Bitlist, exited_BEREIT_FH_TUERMODUL_CTRL_copy_IDX,
					...
					if (BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state == 3) {
						if (step == 1
								...
								&& (time
										- tm_entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRLch_BLOCK_ERKENNUNG_CTRL__N_copy
										== 0.002)) {
							BLOCK_ERKENNUNG_CTRL__N = BLOCK_ERKENNUNG_CTRL__N
									+ 1;
							if ((FH_TUERMODUL__I_EIN
									> BLOCK_ERKENNUNG_CTRL__I_EIN_MAX)) {
								BLOCK_ERKENNUNG_CTRL__I_EIN_MAX =
...
int main(void) {
	...
	klee_make_symbolic(&sc_FH_TUERMODUL_CTRL_2375_2,
			sizeof(sc_FH_TUERMODUL_CTRL_2375_2), "sc_FH_TUERMODUL_CTRL_2375_2");
	...
	klee_make_symbolic(&FH_TUERMODUL_CTRL__N_copy,
			sizeof(FH_TUERMODUL_CTRL__N_copy), "FH_TUERMODUL_CTRL__N_copy ");
	klee_make_symbolic(&FH_TUERMODUL_CTRL__N_old,
			sizeof(FH_TUERMODUL_CTRL__N_old), "FH_TUERMODUL_CTRL__N_old ");
	...
	klee_make_symbolic(&FH_TUERMODUL__I_EIN, sizeof(FH_TUERMODUL__I_EIN),
			"FH_TUERMODUL__I_EIN  ");
	klee_make_symbolic(&FH_TUERMODUL__I_EIN_old,
			sizeof(FH_TUERMODUL__I_EIN_old), "FH_TUERMODUL__I_EIN_old ");
	...
	klee_make_symbolic(&BLOCK_ERKENNUNG_CTRL__N,
			sizeof(BLOCK_ERKENNUNG_CTRL__N), "BLOCK_ERKENNUNG_CTRL__N ");
	...
	klee_make_symbolic(&FH_TUERMODUL__SFHZ_ZENTRAL,
			sizeof(FH_TUERMODUL__SFHZ_ZENTRAL), "FH_TUERMODUL__SFHZ_ZENTRAL  ");
	...
	klee_make_symbolic(&FH_TUERMODUL__SFHZ_MEC_old,
			sizeof(FH_TUERMODUL__SFHZ_MEC_old), "FH_TUERMODUL__SFHZ_MEC_old ");
	klee_make_symbolic(&FH_TUERMODUL__SFHA_ZENTRAL,
			sizeof(FH_TUERMODUL__SFHA_ZENTRAL), "FH_TUERMODUL__SFHA_ZENTRAL  ");
	...
	klee_make_symbolic(&FH_TUERMODUL__SFHA_MEC_old,
			sizeof(FH_TUERMODUL__SFHA_MEC_old), "FH_TUERMODUL__SFHA_MEC_old ");
	...
	klee_make_symbolic(&FH_TUERMODUL__BLOCK_copy,
			sizeof(FH_TUERMODUL__BLOCK_copy), "FH_TUERMODUL__BLOCK_copy ");
	klee_make_symbolic(&FH_TUERMODUL__BLOCK_old,
			sizeof(FH_TUERMODUL__BLOCK_old), "FH_TUERMODUL__BLOCK_old ");
	...
	klee_make_symbolic(&FH_TUERMODUL__SFHZ, sizeof(FH_TUERMODUL__SFHZ),
			"FH_TUERMODUL__SFHZ ");
	klee_make_symbolic(&FH_TUERMODUL__SFHZ_copy,
			sizeof(FH_TUERMODUL__SFHZ_copy), "FH_TUERMODUL__SFHZ_copy ");
	...
	klee_make_symbolic(&FH_TUERMODUL__SFHA, sizeof(FH_TUERMODUL__SFHA),
			"FH_TUERMODUL__SFHA ");
	klee_make_symbolic(&FH_TUERMODUL__SFHA_copy,
			sizeof(FH_TUERMODUL__SFHA_copy), "FH_TUERMODUL__SFHA_copy ");
	...
	klee_make_symbolic(&FH_TUERMODUL__MFHZ, sizeof(FH_TUERMODUL__MFHZ),
			"FH_TUERMODUL__MFHZ ");
	klee_make_symbolic(&FH_TUERMODUL__MFHZ_copy,
			sizeof(FH_TUERMODUL__MFHZ_copy), "FH_TUERMODUL__MFHZ_copy ");
	...
	klee_make_symbolic(&FH_TUERMODUL__MFHA, sizeof(FH_TUERMODUL__MFHA),
			"FH_TUERMODUL__MFHA ");
	klee_make_symbolic(&FH_TUERMODUL__MFHA_copy,
			sizeof(FH_TUERMODUL__MFHA_copy), "FH_TUERMODUL__MFHA_copy ");
	...
	klee_make_symbolic(&FH_TUERMODUL__COM_CLOSE,
			sizeof(FH_TUERMODUL__COM_CLOSE), "FH_TUERMODUL__COM_CLOSE  ");
	...
	klee_make_symbolic(&FH_DU__EKS_LEISTE_AKTIV,
			sizeof(FH_DU__EKS_LEISTE_AKTIV), "FH_DU__EKS_LEISTE_AKTIV  ");
	klee_make_symbolic(&FH_DU__EKS_LEISTE_AKTIV_old,
			sizeof(FH_DU__EKS_LEISTE_AKTIV_old),
			"FH_DU__EKS_LEISTE_AKTIV_old ");
	klee_make_symbolic(&FH_DU__S_FH_TMBFAUFCAN, sizeof(FH_DU__S_FH_TMBFAUFCAN),
	...
	klee_make_symbolic(&FH_DU__S_FH_TMBFAUFCAN_old,
			sizeof(FH_DU__S_FH_TMBFAUFCAN_old), "FH_DU__S_FH_TMBFAUFCAN_old ");
	...
	klee_make_symbolic(&FH_DU__S_FH_TMBFZUCAN_copy,
			sizeof(FH_DU__S_FH_TMBFZUCAN_copy), "FH_DU__S_FH_TMBFZUCAN_copy ");
	klee_make_symbolic(&FH_DU__S_FH_TMBFZUCAN_old,
			sizeof(FH_DU__S_FH_TMBFZUCAN_old), "FH_DU__S_FH_TMBFZUCAN_old ");
	...
	klee_make_symbolic(&FH_DU__S_FH_TMBFZUDISC_old,
			sizeof(FH_DU__S_FH_TMBFZUDISC_old), "FH_DU__S_FH_TMBFZUDISC_old ");
	klee_make_symbolic(&FH_DU__S_FH_TMBFAUFDISC,
			sizeof(FH_DU__S_FH_TMBFAUFDISC), "FH_DU__S_FH_TMBFAUFDISC  ");
	...
	klee_make_symbolic(&FH_DU__S_FH_AUFDISC, sizeof(FH_DU__S_FH_AUFDISC),
			"FH_DU__S_FH_AUFDISC  ");
	klee_make_symbolic(&FH_DU__DOOR_ID, sizeof(FH_DU__DOOR_ID),
			"FH_DU__DOOR_ID  ");
