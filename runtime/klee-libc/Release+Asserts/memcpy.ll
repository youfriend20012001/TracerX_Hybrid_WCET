...
define i8* @memcpy(i8* %destaddr, i8* nocapture readonly %srcaddr, i64 %len) #0 {
  ...
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !30
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %next.gep.sum279 = or i64 %index, 16, !dbg !31
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !31
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !31
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !31
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !31
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !31
  %next.gep103.sum296 = or i64 %index, 16, !dbg !31
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !31
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !31
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !31
...
.lr.ph:                                           ; preds = %middle.block, %.lr.ph
  ...
  tail call void @llvm.dbg.value(metadata !{i8* %13}, i64 0, metadata !18), !dbg !31
...
!0 = metadata !{i32 786449, metadata !1, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/tannguyen/Dropbox/NUS/Test_Merge/TracerX_Taint/runtime/klee-libc//home/tannguyen/Dropbox/NUS/Test_Merge/TracerX_Taint/runtime/klee-libc/memcpy.c] [DW_LANG_C89]
!1 = metadata !{metadata !"/home/tannguyen/Dropbox/NUS/Test_Merge/TracerX_Taint/runtime/klee-libc/memcpy.c", metadata !"/home/tannguyen/Dropbox/NUS/Test_Merge/TracerX_Taint/runtime/klee-libc"}
!2 = metadata !{i32 0}
...
!5 = metadata !{metadata !"memcpy.c", metadata !"/home/tannguyen/Dropbox/NUS/Test_Merge/TracerX_Taint/runtime/klee-libc"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/tannguyen/Dropbox/NUS/Test_Merge/TracerX_Taint/runtime/klee-libc/memcpy.c]
