...
public:
	...
	public:
		RawAbstractState(ExecutionState &state) {
			this->state = new ExecutionState(state);
	...
	public:
		...
		//std::map<ExecutionPath, HSETSummary> exactInternalNodeDictionary;
		//std::map<ExecutionPath, HSETSummary> exactLeafNodeDictionary;
...
public:
	...
	HSETSummary runWithSymbolicExecution(ExecutionState &state,
			std::string guilde,int depth, Executor::HSETAbstractMethods abstractMethod, bool IsAbstractWalk);

	HSETSummary runWithExecutionTree(PTreeNode *runningNode,
				std::string guilde,int depth, Executor::HSETAbstractMethods abstractMethod);
